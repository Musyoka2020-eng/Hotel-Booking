...
if(isset($send))
{
mysqli_query($con,"INSERT into feedback values('','$n','$e','$mbl','$msg')");	
...
<footer style="background-color: #393939;">
  ...
  <ul class="nav navbar-nav">
        <li><a href="index.php"title="Home">Luxury HOTEL</a></li>
     </ul></button>
    <p class="text-justify">Luxury is a hotel situated in Machakos County, one kilometer from Machakos town. 
        It provides accommodation, food and beverage and different types of services.</p><br>
...
?>
	...
	<div class="col-sm-4 text-justify">
      ...
      <p style="color:white;"><strong>Address:&nbsp;</strong>Machakos</p>
      <p style="color:white;"><strong>Email-Id:&nbsp;</strong>Luxury@gmail.com</p>
      <p style="color:white;"><strong>Contact Us:&nbsp;</strong>(+254) 712345678</p><br><br><br>
     	</div>&nbsp;
